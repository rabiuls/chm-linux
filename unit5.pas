...
{$mode objfpc}{$H+}
(*
&c139,131,120;&bAll praises to Allah.
&c139,131,120;&bPeace be upon Muhammad.
&u<------------------------------------------------------------------->
...
&bCreated on Lazarus IDE/Free Pascal.
&bBased on the chm library by
&bAndrew Haines.

Other components used:
&bTScrollingCredits version 1.2 by
&bRaoul Snyman

&bImages used are from:
